...
export async function scrapeWebsite(url, slug = 'index', folderName) {
  ...
  for (const link of links) {
    ...
    try {
      ...
      console.error('Error fetching CSS:', fullUrl, err.message);
    }
  }
  ...
  for (const script of scripts) {
    ...
    try {
      ...
      console.error('Error fetching JS:', fullUrl, err.message);
    }
  }
  ...
  for (const img of images) {
    ...
    try {
      ...
      console.error('Error fetching Image:', fullUrl, err.message);
    }
  }
